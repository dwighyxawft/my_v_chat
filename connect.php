                ...
                <div class="col-md-8 logs d-flex align-items-center justify-content-center">
                    <div class="text-center">
                        <div class="text-center">
                            ...
                            <?php }else{?>
                                <img src="assets/images/<?php echo $profileData->profileImage; ?>" alt="user image" class="rounded-circle user_image">
                                <p class="pt-1"><b><?php echo $profileData->name;?></b></p>
                            <?php }?>
                            <h1 class="fw-light">Keep your webcam connected</h1>
                            <p>Do you want to make a call</p>
                            <button class="btn btn-success rounded-circle px-3 py-3 mb-3 mb-sm-0" id="callBtn" data-user="<?php echo $profileData->userID;?>"><i class="fa fa-video-camera fa-2x"></i></button>
                        </div>
                    </div>
                </div>
            </div>
